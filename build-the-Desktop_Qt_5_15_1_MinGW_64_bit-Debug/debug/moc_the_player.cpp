...
#include <memory>
#include "../../cycle_3_code/the_player.h"
...
QT_MOC_LITERAL(9, 88, 9), // "nextMedia"
QT_MOC_LITERAL(10, 98, 9), // "prevMedia"
QT_MOC_LITERAL(11, 108, 11), // "selectMedia"
QT_MOC_LITERAL(12, 120, 5), // "title"
QT_MOC_LITERAL(13, 126, 8) // "addMedia"

    },
    "ThePlayer\0shuffle\0\0playStateChanged\0"
    "QMediaPlayer::State\0ms\0jumpTo\0"
    "TheButtonInfo*\0button\0nextMedia\0"
    "prevMedia\0selectMedia\0title\0addMedia"
};
...
void ThePlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->nextMedia(); break;
        case 4: _t->prevMedia(); break;
        case 5: _t->selectMedia((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 6: _t->addMedia(); break;
        default: ;
        }
