...
"}"));
        ...
        addVideos = new QPushButton(centralwidget);
        addVideos->setObjectName(QString::fromUtf8("addVideos"));
        addVideos->setMinimumSize(QSize(140, 100));
        QPalette palette1;
...
#endif
        addVideos->setPalette(palette1);
        QFont font2;
        font2.setFamily(QString::fromUtf8("Arial"));
        font2.setPointSize(10);
        font2.setBold(true);
        font2.setWeight(75);
        addVideos->setFont(font2);
        addVideos->setCursor(QCursor(Qt::PointingHandCursor));
        addVideos->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"	background-color:rgb(18, 18, 18);\n"
"	color: white;\n"
"	border-style: outset;\n"
"	border-width: 0.5px;\n"
...
"}"));
        addVideos->setLocale(QLocale(QLocale::English, QLocale::UnitedKingdom));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/prefix1/resources/add_circle_outline-white-24dp.svg"), QSize(), QIcon::Normal, QIcon::Off);
        addVideos->setIcon(icon);

        verticalLayout_2->addWidget(addVideos);
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        addVideos->setText(QCoreApplication::translate("MainWindow", "Add Videos", nullptr));
