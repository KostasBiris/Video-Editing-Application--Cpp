...
"}"));
        ...
        pushButton_3->setMinimumSize(QSize(70, 100));
        QFont font1;
...
"}"));
        ...
        pushButton->setMinimumSize(QSize(70, 100));
...
"}"));
        ...
        search->setMinimumSize(QSize(140, 100));
        QPalette palette3;
...
"	background-repeat: no-repeat;\n"
"}"));
        search->setLocale(QLocale(QLocale::English, QLocale::UnitedKingdom));
        QIcon icon4;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setText(QCoreApplication::translate("MainWindow", "Del", nullptr));
